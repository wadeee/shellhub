...
mysqldump -uroot -ppassword --disable-keys --create-options --skip-extended-insert --routines --events --triggers --default-character-set=utf8mb4 --single-transaction mayercnc_web > /root/backup/mayercnc_web.sql
